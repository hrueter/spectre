...
function(generate_algorithms_impl ALGORITHM_NAME ALGORITHM_TYPE ALGORITHM_DIR)
  ...
  #
  # Only inline if we are running on more than 1 core
  execute_process(
    COMMAND bash -c
    "perl -pi -e 's/CK_MSG_INLINE/([]() { static const auto pes = CkNumPes(); return pes > 1; }() ? CK_MSG_INLINE : 0)/g' Algorithm${ALGORITHM_NAME}.def.h \
     ...
     \
     \
     && perl -pi -e 's/->template receive_data<ReceiveTag, ReceiveData_t>/->template receive_data<ReceiveTag>/g' Algorithm${ALGORITHM_NAME}.def.h"
