...
struct ComputeDuDt {
  using argument_tags =
      tmpl::list<Pi, ::Tags::deriv<Pi, tmpl::size_t<Dim>, Frame::Inertial>,
                 ::Tags::deriv<PhiR, tmpl::size_t<Dim>, Frame::Inertial>,
                 ::Tags::deriv<PhiA<Dim>, tmpl::size_t<Dim>, Frame::Inertial>>;
  static void apply(
      gsl::not_null<Scalar<DataVector>*> dt_pi,
      gsl::not_null<Scalar<DataVector>*> dt_phiR,
      gsl::not_null<tnsr::i<DataVector, Dim - 1, Frame::Inertial>*> dt_phiA,
...
struct UpwindFlux {
 ...
 public:
  ...
  // `()` operator.
  using package_tags =
      tmpl::list<::Tags::NormalDotFlux<Pi>, ::Tags::NormalDotFlux<PhiR>,
                 ::Tags::NormalDotFlux<PhiA<Dim>>, Pi, NormalTimesFluxPi>;
  ...
  using argument_tags =
      tmpl::list<::Tags::NormalDotFlux<Pi>, ::Tags::NormalDotFlux<PhiR>,
                 ::Tags::NormalDotFlux<PhiA<Dim>>, Pi,
                 ::Tags::Normalized<::Tags::UnnormalizedFaceNormal<Dim>>>;
  ...
  void operator()(
      ...
      gsl::not_null<Scalar<DataVector>*> phiR_normal_dot_numerical_flux,
      gsl::not_null<tnsr::i<DataVector, Dim - 1, Frame::Inertial>*>
