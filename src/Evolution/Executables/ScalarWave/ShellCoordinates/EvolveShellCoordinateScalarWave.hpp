...
#include "Evolution/Systems/ScalarWave/ShellCoordinates/Equations.hpp"  // IWYU pragma: keep // for UpwindFlux
...
struct EvolutionMetavars {
  ...
  using system = ScalarWave::ShellCoordinates::System<Dim>;
  ...
  using normal_dot_numerical_flux =
      Tags::NumericalFlux<ScalarWave::ShellCoordinates::UpwindFlux<Dim>>;
  ...
  using step_actions = tmpl::flatten<tmpl::list<
      ...
      tmpl::conditional_t<
          ...
          dg::Actions::Filter<
              ...
              tmpl::list<ScalarWave::ShellCoordinates::Pi,
                         ScalarWave::ShellCoordinates::Psi,
                         ScalarWave::ShellCoordinates::PhiR,
                         ScalarWave::ShellCoordinates::PhiA<Dim>>>,
          tmpl::list<>>>>;
