...
#include "Evolution/Systems/DualFoliationScalarWave/Equations.hpp"  // IWYU pragma: keep // for UpwindFlux
#include "Evolution/Systems/DualFoliationScalarWave/System.hpp"
...
struct EvolutionMetavars {
  ...
  using system = DualFoliationScalarWave::System<Dim>;
  using temporal_id = Tags::TimeStepId;
  static constexpr bool local_time_stepping = true;
  using initial_data_tag =
      Tags::AnalyticSolution<ScalarWave::Solutions::RegularSphericalWave>;
  ...
  // The dual foliation scalar wave system generally does not require filtering,
  // except possibly on certain deformed domains.  Here a filter is added in 2D
  // for testing purposes.  When performing numerical experiments with the dual
  // foliation scalar wave system, the user should determine whether this filter
  // can be removed.
