...
spectre_run_cmake() {
    ...
    cmake -D CHARM_ROOT=$CHARM_ROOT \
          ...
          -D PYTHONINTERP_FOUND=TRUE \
          -D PYTHON_EXECUTABLE=/mnt/bwpy/single/usr/bin/python \
          -D PYTHON_VERSION_STRING="3.5.5" \
          -D PYTHON_VERSION_MAJOR=3 \
          -D PYTHON_VERSION_MINOR=5 \
          -D PYTHON_VERSION_PATCH=5 \
