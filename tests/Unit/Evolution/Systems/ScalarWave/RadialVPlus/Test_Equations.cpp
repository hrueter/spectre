...
SPECTRE_TEST_CASE("Unit.Evolution.Systems.ScalarWave.RadialVPlus.DuDt",
                  "[Unit][Evolution]") {
...
SPECTRE_TEST_CASE(
    "Unit.Evolution.Systems.ScalarWave.RadialVPlus.NormalDotFluxes",
    "[Unit][Evolution]") {
  constexpr double time = 0.7;
...
SPECTRE_TEST_CASE("Unit.Evolution.Systems.ScalarWave.RadialVPlus.UpwindFlux",
                  "[Unit][Evolution]") {
  constexpr double time = 0.7;
...
SPECTRE_TEST_CASE("Unit.Evolution.Systems.ScalarWave.RadialVPlus.PenaltyFlux",
                  "[Unit][Evolution]") {
  pypp::SetupLocalPythonEnvironment local_python_env{
      "Evolution/Systems/ScalarWave/RadialVplus"};
